  ...
  if(e.target.nodeName === 'TD') {
      ...
      if (selectedRow) {
        ...
        for (var i=0;i<tr.length;i++){
          ...
          let startTime=Number(e.target.parentElement.children[1].textContent)+3;
          let endTime=Number(e.target.parentElement.nextElementSibling.children[1].textContent)+3;
